...
-    **Econometría** → dirigida a estudiantes de la *mención Economía*, con énfasis en el razonamiento teórico y la modelación econométrica aplicada a la investigación económica.
...
\
[Ver Curso](eco_eco.html){.btn target="_blank" rel="noopener"}
:::

::: lab-card
### Econometría para la Gestión Mención Administración
\
[Ver Curso](eco_epg.html){.btn target="_blank" rel="noopener"}
:::
:::::
