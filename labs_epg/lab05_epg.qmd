...
[Descargar PDF de contenidos teóricos](pdf_epg/Capitulo_5 _Logit_y_otros _analisis.pdf){.btn .btn-outline-primary role="button" download="true"}

[Descargar PDF de contenidos teóricos](pdf_epg/Capitulo_5.1_logit_y_probit.pdf){.btn .btn-outline-primary role="button" download="true"}
