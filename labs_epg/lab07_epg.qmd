...
[Descargar PDF de contenidos teóricos](pdf_epg/Capitulo_7_Analisis_Factorial.pdf){.btn .btn-outline-primary role="button" download="true"}

[Descargar PDF de contenidos teóricos](pdf_epg/Capitulo_7.1_Analisis_Factorial.pdf){.btn .btn-outline-primary role="button" download="true"}
