...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, toptitle=1mm, coltitle=black, leftrule=.75mm, rightrule=.15mm, colback=white, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, breakable, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, opacityback=0, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, toptitle=1mm, coltitle=black, leftrule=.75mm, rightrule=.15mm, colback=white, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, opacityback=0, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white]
...
\[\text{Costo_Mantenimiento} = \beta_0 + \beta_1
\cdot \text{Tiempo_operacion} + \varepsilon \]
