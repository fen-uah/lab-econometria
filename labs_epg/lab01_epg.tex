...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, opacityback=0, leftrule=.75mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, opacitybacktitle=0.6, breakable, left=2mm, colback=white, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, rightrule=.15mm, arc=.35mm, colframe=quarto-callout-tip-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, opacityback=0, leftrule=.75mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, opacitybacktitle=0.6, breakable, left=2mm, colback=white, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, rightrule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame]
