...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, left=2mm, opacitybacktitle=0.6, breakable, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, opacityback=0, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, rightrule=.15mm, colback=white, bottomtitle=1mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, left=2mm, opacitybacktitle=0.6, breakable, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, opacityback=0, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, rightrule=.15mm, colback=white, bottomtitle=1mm, coltitle=black]
