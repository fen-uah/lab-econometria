...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, toprule=.15mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, coltitle=black, titlerule=0mm, leftrule=.75mm, opacitybacktitle=0.6, rightrule=.15mm, colback=white, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, left=2mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, toprule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, coltitle=black, titlerule=0mm, leftrule=.75mm, opacitybacktitle=0.6, rightrule=.15mm, colback=white, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, arc=.35mm]
